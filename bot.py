...
# --- Вступление ---
INTRO_TEXT = """
☠️ Кхе-кхе... Значит, явилися к вам, морские крысы....
...
Вас шестеро — пройдите шесть испытаний. Каждое откроет часть моего последнего письма. Сложите всё вместе — узнаете, где моё сокровище.

Якорь вам в задницу, если облажаетесь.

Как будете готовы начинать, маекнете! ⚓
"""

# --- Подсказка куда плыть перед точкой 1 (отправляется по /start) ---
START_HINT = "🗺 Вижу что вы готовы. Снимайте швартовы! Курс на Первую Преграду — плывите к дамбе на реке!"
...
""",
    ...
    {
        "riddle": """
📍 ТОЧКА 6 — МЕСТО СЛИЯНИЯ

Вот оно. Место, где душа сливается с речным ветром.
Лопань и Харьков встречаются здесь и текут дальше — вместе.

Капитан Черкас ценил одного человека на корабле больше всех.
...
# --- Финал ---
FINALE_TEXT = """
⚓ И вот, письмо капитана Черкаса собралось воедино...
...
И сейчас он отведет вас всех в тайное место, где покажет это сокровище. Интересно что же я там спрятал?....
